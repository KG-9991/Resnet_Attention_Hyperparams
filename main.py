...
def configure():
    ...
    parser.add_argument("--modeldir", type=str, default='model_hyper_attn_withdropout0.5', help='model directory')
...
def main(config):
    ...
    ### YOUR CODE HERE
    data_dir = "/gpfs/scratch/kgayadhankar/Resnet_Attention_Hyperparams/cifar-10-batches-py"
    ### YOUR CODE HERE
    ...
    for i in batch_sizes:
        for j in learning_rates:
            ...
            print("The hyperparameters for model",config.model_number,"used are: Batch Size",config.batch_size,"Learning Rate:",config.learning_rate)
            model = Cifar(config).cuda()     
